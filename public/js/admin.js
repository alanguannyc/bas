...
function format(d) {
    ...
    return '<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;">' + '<tr>' + '<td>Full name:</td>' + '<td>' + d.name + '</td>' + '</tr>' + '<tr>' + '<td>Email:</td>' + '<td>' + d.email + '</td>' + '</tr>' + '<tr>' + '<td>Company:</td>' + '<td>' + d.profile.company + '</td>' + '</tr>' + '<tr>' + '<td>Title:</td>' + '<td>' + d.profile.title + '</td>' + '</tr>' + '<tr>' + '<td>Phone:</td>' + '<td>' + d.profile.phone + '</td>' + '</tr>' + '<tr>' + '<td>Address:</td>' + '<td>' + d.profile.address + '</td>' + '</tr>' + '</table>';
}

axios.get('/admin/user/api').then(function (res) {
