...
var update = __webpack_require__(5)("89b8cd50", content, false, {});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__App_vue__ = __webpack_require__(35);
...
Vue.component('messenge-vue', __webpack_require__(61));
Vue.component('member-nomination', __webpack_require__(64));
Vue.component('nomination-detail', __webpack_require__(71));
Vue.component('nomination-show', __webpack_require__(74));
Vue.component('user-index', __webpack_require__(82));
var app = new Vue({
    el: '#admin'
...
function format(d) {
    ...
    return '<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;">' + '<tr>' + '<td>Full name:</td>' + '<td>' + d.name + '</td>' + '</tr>' + '<tr>' + '<td>Email:</td>' + '<td>' + d.user.profile.company + '</td>' + '</tr>' + '<tr>' + '<td>Company:</td>' + '<td>' + d.q1 + '</td>' + '</tr>' + '<tr>' + '<td>Title:</td>' + '<td>' + d.q2 + '</td>' + '</tr>' + '<tr>' + '<td>Phone:</td>' + '<td>' + d.q3 + '</td>' + '</tr>' + '<tr>' + '<td>Address:</td>' + '<td>' + d.q4 + '</td>' + '</tr>' + '</table>';
}
...
$(document).ready(function () {
    ...
    var nomination_table = $('#nomination_table').DataTable({
        ...
        columns: [{
            ...
            "data": null,
            "defaultContent": 'view'
        }, { data: 'category' }, { data: 'name' }, { data: 'user.profile.company',
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2), __webpack_require__(69)(module)))
